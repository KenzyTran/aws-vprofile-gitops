---
title: "6.2 Generate pipeline with AI"
date: 2025-01-01
weight: 2
---
...
Expected `ci.yml` structure (3 jobs): `build-and-sonar` (on pull_request), `docker-build-push`
(on push, outputs image_tag + ecr_registry), `update-helm` (on push, needs docker-build-push).
